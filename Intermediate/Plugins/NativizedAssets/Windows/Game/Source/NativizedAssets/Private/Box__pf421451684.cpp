...
ABox_C__pf421451684::ABox_C__pf421451684(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABox_C__pf421451684::StaticClass() == GetClass()))
	{
		ABox_C__pf421451684::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__SmallCube__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("SmallCube"));
	RootComponent = bpv__SmallCube__pf;
	bpv__FOWComponent__pf = CreateDefaultSubobject<UFOWComponent_C__pf1242490746>(TEXT("FOWComponent"));
	bpv__SmallCube__pf->CreationMethod = EComponentCreationMethod::Native;
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__SmallCube__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABox_C__pf421451684::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__1 = (*(AccessPrivateProperty<float >(&(bpv__SmallCube__pf->BodyInstance), FBodyInstance::__PPO__MassInKgOverride() )));
	__Local__1 = 37.383720f;
	if(!bpv__SmallCube__pf->IsTemplate())
	{
		bpv__SmallCube__pf->BodyInstance.FixupData(bpv__SmallCube__pf);
	}
	bpv__FOWComponent__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__FOWComponent__pf->bpv__HideInFOW__pf = true;
	bpv__FOWComponent__pf->bpv__Radius__pf = 50.000000f;
	bpv__Type__pf = E__VisibilityMode__pf::NewEnumerator0;
}
void ABox_C__pf421451684::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__SmallCube__pf)
	{
		bpv__SmallCube__pf->CreationMethod = EComponentCreationMethod::Native;
	}
...
void ABox_C__pf421451684::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ABox_C__pf421451684::bpf__UserConstructionScript__pf()
{
	...
	do
	{
		...
		case 2:
			{
				if(IsValid(bpv__SmallCube__pf))
				{
					bpv__SmallCube__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABox_C__pf421451684::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 3:
			{
		...
		case 5:
			{
				if(IsValid(bpv__SmallCube__pf))
				{
					bpv__SmallCube__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABox_C__pf421451684::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
				}
			}
		case 6:
			{
		...
		case 8:
			{
				if(IsValid(bpv__SmallCube__pf))
				{
					bpv__SmallCube__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABox_C__pf421451684::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
				}
			}
		case 9:
			{
...
void ABox_C__pf421451684::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{220, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/FogOfWar/ExampleMap/Meshes/Mesh_SmallCube.Mesh_SmallCube 
...
void ABox_C__pf421451684::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__ABox_C__pf421451684
{
	FRegisterHelper__ABox_C__pf421451684()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/FogOfWar/ExampleMap/Blueprints/Box"), &ABox_C__pf421451684::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABox_C__pf421451684 Instance;
};
FRegisterHelper__ABox_C__pf421451684 FRegisterHelper__ABox_C__pf421451684::Instance;
