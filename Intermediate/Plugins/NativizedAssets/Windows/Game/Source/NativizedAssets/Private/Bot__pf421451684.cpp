...
ABot_C__pf421451684::ABot_C__pf421451684(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABot_C__pf421451684::StaticClass() == GetClass()))
	{
		ABot_C__pf421451684::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__4->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABot_C__pf421451684::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__4->OverrideMaterials = TArray<UMaterialInterface*> ();
	__Local__4->OverrideMaterials.Reserve(1);
	__Local__4->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABot_C__pf421451684::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
...
void ABot_C__pf421451684::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
void ABot_C__pf421451684::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ABot_C__pf421451684::bpf__ExecuteUbergraph_Bot__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void ABot_C__pf421451684::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Bot__pf_0(1);
}
void ABot_C__pf421451684::bpf__UserConstructionScript__pf()
{
		...
		case 2:
			{
				...
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABot_C__pf421451684::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
				}
			}
		case 3:
			{
		...
		case 5:
			{
				if(IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))))
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABot_C__pf421451684::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 6:
			{
		...
		case 8:
			{
				if(IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))))
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABot_C__pf421451684::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
				}
			}
		case 9:
			{
...
void ABot_C__pf421451684::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
void ABot_C__pf421451684::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__ABot_C__pf421451684
{
	FRegisterHelper__ABot_C__pf421451684()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/FogOfWar/ExampleMap/Blueprints/Bot"), &ABot_C__pf421451684::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABot_C__pf421451684 Instance;
};
FRegisterHelper__ABot_C__pf421451684 FRegisterHelper__ABot_C__pf421451684::Instance;
