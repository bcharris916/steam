...
ABP_Sky_Sphere_C__pf1379775596::ABP_Sky_Sphere_C__pf1379775596(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__1 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__SkyxSpherexmesh__pfTT), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Sky_Sphere_C__pf1379775596::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((UBoolProperty*)__Local__2)->SetPropertyValue_InContainer((bpv__SkyxSpherexmesh__pfTT), false, 0));
...
void ABP_Sky_Sphere_C__pf1379775596::bpf__UpdateSunDirection__pf()
{
	...
	bpfv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf = UKismetMathLibrary::Conv_ColorToLinearColor(((IsValid(bpv__Directionalxlightxactor__pfTT) && IsValid((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() ))))) ? ((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() )))->LightColor) : (__Local__6)));
	if(IsValid(bpv__Skyxmaterial__pfT))
	{
		bpv__Skyxmaterial__pfT->UMaterialInstanceDynamic::SetVectorParameterValue(FName(TEXT("Sun color")), bpfv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf);
	}
...
void ABP_Sky_Sphere_C__pf1379775596::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	{
		{141, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Engine/EngineSky/SM_SkySphere.SM_SkySphere 
		{142, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Engine/EngineSky/M_Sky_Panning_Clouds2.M_Sky_Panning_Clouds2 
		{143, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Engine/EngineSky/C_Sky_Horizon_Color.C_Sky_Horizon_Color 
		{144, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Engine/EngineSky/C_Sky_Zenith_Color.C_Sky_Zenith_Color 
		{145, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Engine/EngineSky/C_Sky_Cloud_Color.C_Sky_Cloud_Color 
	};
...
void ABP_Sky_Sphere_C__pf1379775596::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{147, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.DirectionalLight 
		...
		{149, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Light 
		{150, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.LightComponentBase 
