...
ABP_LightStudio_C__pf1079297466::ABP_LightStudio_C__pf1079297466(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__0 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__Skybox__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__0 = ECollisionEnabled::Type::NoCollision;
	auto& __Local__1 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Skybox__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__2.AddUninitialized(8);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__2.GetData(), 8);
	...
	auto& __Local__11 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Skybox__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__11 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_LightStudio_C__pf1079297466::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto& __Local__12 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__PrevisArrow__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__12 = ECollisionEnabled::Type::NoCollision;
	auto& __Local__13 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__PrevisArrow__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__14.AddUninitialized(8);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__14.GetData(), 8);
	auto& __Local__15 = __Local__14[0];
	__Local__15.Channel = FName(TEXT("WorldStatic"));
	__Local__15.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__16 = __Local__14[1];
	__Local__16.Channel = FName(TEXT("WorldDynamic"));
	__Local__16.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__17 = __Local__14[2];
	__Local__17.Channel = FName(TEXT("Pawn"));
	...
	__Local__20.Channel = FName(TEXT("PhysicsBody"));
	...
	auto& __Local__22 = __Local__14[7];
	__Local__22.Channel = FName(TEXT("Destructible"));
	__Local__22.Response = ECollisionResponse::ECR_Ignore;
	bpv__PrevisArrow__pf->BodyInstance.bAutoWeld = false;
	auto& __Local__23 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__PrevisArrow__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__23 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_LightStudio_C__pf1079297466::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	bpv__SkyLight1__pf->LightGuid = FGuid(0x1952F317, 0x493172F1, 0x9DFDEDA0, 0x4162862A);
...
void ABP_LightStudio_C__pf1079297466::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__24 = NewObject<UDirectionalLightComponent>(InDynamicClass, UDirectionalLightComponent::StaticClass(), TEXT("NODE_AddDirectionalLightComponent-0"));
	InDynamicClass->ComponentTemplates.Add(__Local__24);
	auto __Local__25 = NewObject<UDirectionalLightComponent>(InDynamicClass, UDirectionalLightComponent::StaticClass(), TEXT("NODE_AddDirectionalLightComponent-1"));
	InDynamicClass->ComponentTemplates.Add(__Local__25);
	auto __Local__26 = NewObject<UAtmosphericFogComponent>(InDynamicClass, UAtmosphericFogComponent::StaticClass(), TEXT("NODE_AddAtmosphericFogComponent-0"));
	InDynamicClass->ComponentTemplates.Add(__Local__26);
	auto __Local__27 = NewObject<UAtmosphericFogComponent>(InDynamicClass, UAtmosphericFogComponent::StaticClass(), TEXT("NODE_AddAtmosphericFogComponent-1"));
	InDynamicClass->ComponentTemplates.Add(__Local__27);
	auto __Local__28 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("SceneComponent_22"));
	InDynamicClass->ComponentTemplates.Add(__Local__28);
	__Local__24->DynamicShadowDistanceMovableLight = 200000.000000f;
	__Local__24->CascadeDistributionExponent = 4.000000f;
	__Local__24->ShadowBias = 0.400000f;
	__Local__24->bAffectDynamicIndirectLighting = true;
	__Local__24->LightGuid = FGuid(0xEC7DF5F9, 0x44378A32, 0x786E24AE, 0xCED4B447);
	__Local__24->Intensity = 3.141593f;
	__Local__25->ShadowBias = 0.400000f;
	__Local__25->bAffectDynamicIndirectLighting = true;
	__Local__25->LightGuid = FGuid(0xF7025B04, 0x40EEDED1, 0x49634993, 0x4664B71A);
	__Local__25->Intensity = 3.141593f;
	__Local__25->Mobility = EComponentMobility::Type::Stationary;
	auto& __Local__29 = (*(AccessPrivateProperty<FAtmospherePrecomputeParameters >((__Local__26), UAtmosphericFogComponent::__PPO__PrecomputeParams() )));
	__Local__29.DensityHeight = 0.800000f;
}
		...
		case 4:
			{
				...
				bpfv__CallFunc_AddComponent_ReturnValue2__pf = CastChecked<UDirectionalLightComponent>(AActor::AddComponent(FName(TEXT("NODE_AddDirectionalLightComponent-0")), false, bpfv__Temp_struct_Variable2__pf, this), ECastCheckedType::NullAllowed);
			}
		case 5:
			{
...
void ABP_LightStudio_C__pf1079297466::bpf__AtmosphereDensity__pf()
{
	...
	do
	{
		...
		case 2:
			{
				bpfv__Temp_struct_Variable2__pf = FTransform( FQuat(0.000000,-0.000000,0.000000,1.000000), FVector(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000) );
				bpfv__CallFunc_AddComponent_ReturnValue2__pf = CastChecked<UAtmosphericFogComponent>(AActor::AddComponent(FName(TEXT("NODE_AddAtmosphericFogComponent-0")), false, bpfv__Temp_struct_Variable2__pf, this), ECastCheckedType::NullAllowed);
			}
		case 3:
			{
...
void ABP_LightStudio_C__pf1079297466::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	{
		{167, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Blueprints/Assets/Skybox.Skybox 
		{168, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_Master.M_LightStage_Skybox_Master 
		{169, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Blueprints/Assets/SM_Arrows.SM_Arrows 
		{170, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/StarterContent/Blueprints/Assets/M_LightStage_Arrows.M_LightStage_Arrows 
		{171, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Game/StarterContent/Blueprints/Assets/SunlightColorLUT.SunlightColorLUT 
		{172, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveFloat /Game/StarterContent/Blueprints/Assets/FogBrightnessLUT.FogBrightnessLUT 
		{173, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  TextureCube /Game/StarterContent/HDRI/HDRI_Epic_Courtyard_Daylight.HDRI_Epic_Courtyard_Daylight 
		{174, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_Black.M_LightStage_Skybox_Black 
		{175, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_HDRI.M_LightStage_Skybox_HDRI 
	};
...
void ABP_LightStudio_C__pf1079297466::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{146, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/Engine.StaticMeshComponent 
		{176, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/Engine.ExponentialHeightFogComponent 
		{177, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/Engine.SkyLightComponent 
		...
		{178, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/Engine.AtmosphericFogComponent 
		...
		{179, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/Engine.DirectionalLightComponent 
		{151, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.CurveLinearColor 
		{53, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/Engine.HitResult 
		{180, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.MaterialInterface 
		...
		{182, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.MaterialInstance 
		{183, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Texture 
		{164, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.LightComponent 
		{184, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.CurveFloat 
